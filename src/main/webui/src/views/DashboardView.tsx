            ...
            <div className={"gap-4 flex"}>
                ...
                <Card className={"w-96"}>
                    <CardHeader className={"flex items-center"}>
                        ...
                        <CardAction className={"ml-auto"}><Button className={"ml-auto"}
                                                                  size={"icon-sm"}>+</Button></CardAction>
                    </CardHeader>
                    <CardContent>
                        ...
                        <TransactionItem transaction={{
                            ...
                            asset: {name: "Euros"},
                            date: new Date().toISOString(),
                            wallet: {name: "TR Holdings"}
                        }}/>
                        <ArrowDownUp
                            className={"ml-auto mr-auto my-[-1.25rem] z-10 outline size-6 bg-white p-1 rounded-md"}/>
                        <TransactionItem transaction={{
                            name: "Trade Republic",
                            amount: -500,
                            asset: {name: "Euros"},
